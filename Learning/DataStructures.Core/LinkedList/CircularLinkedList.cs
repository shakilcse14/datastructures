...
{
    public class CircularLinkedList<T> : ILinkedList<T>, IEnumerable
    {
        ...
        public void Add(T data)
        {
            ...
            else
            {
                ...
                _tailNode.NextNode = _headNode;
                _headNode.PreviousNode = _tailNode;
            }
        }
        ...
        public void RemoveLast()
        {
            ...
            _tailNode.PreviousNode.NextNode = _headNode;
            _headNode.PreviousNode = _tailNode.PreviousNode;
        }
